<template>
  <div class="grid grid-cols-10 gap-3 min-w-[1160px]">
    <p
      :style="{ paddingLeft: `${props.paddingLeft}rem` }"
      class="font-bold col-span-10"
    >
      {{ props.category.name }}
    </p>
    <div
      class="col-span-10 grid grid-cols-10 gap-3 hover:bg-gray-50"
      v-for="p in props.category.products"
      :key="p.id"
    >
      <p
        :style="{ paddingLeft: `${props.paddingLeft + 1}rem` }"
        class="font-medium col-span-3"
      >
        {{ p.product_details.purchase_description }}
      </p>
      <p class="col-span-2">{{ p.preferred_supplier.company_name }}</p>
    ...
    <!-- Add another layer -->
    <div
      class="col-span-10 flex flex-col gap-4"
    ...
    <div class="col-span-10 gap-3 grid grid-cols-10 hover:bg-gray-50">
      <p
        :style="{ paddingLeft: `${props.paddingLeft}rem` }"
      ...
      <p class="col-span-1 text-right mr-2 border-t-2 border-black font-bold">
